...
const MOCK_STOCKS: Stock[] = [
    ...
    { symbol: "TTRAK", name: "Türk Traktör", basePrice: 700, exchange: 'BIST' } as any,
    { symbol: "DOHOL", name: "Doğan Holding", basePrice: 12, exchange: 'BIST' } as any,
    { symbol: "ULKER", name: "Ülker Bisküvi", basePrice: 85, exchange: 'BIST' } as any,
    { symbol: "SOKM", name: "Şok Marketler", basePrice: 60, exchange: 'BIST' } as any,
    { symbol: "MAVI", name: "Mavi Giyim", basePrice: 110, exchange: 'BIST' } as any,
    { symbol: "TKFEN", name: "Tekfen Holding", basePrice: 45, exchange: 'BIST' } as any,
    { symbol: "AEFES", name: "Anadolu Efes", basePrice: 130, exchange: 'BIST' } as any,
    { symbol: "AGHOL", name: "AG Anadolu Grubu", basePrice: 200, exchange: 'BIST' } as any,
    { symbol: "AKSEN", name: "Aksa Enerji", basePrice: 40, exchange: 'BIST' } as any,
    { symbol: "ALBRK", name: "Albaraka Türk", basePrice: 4, exchange: 'BIST' } as any,
    { symbol: "ASUZU", name: "Anadolu Isuzu", basePrice: 230, exchange: 'BIST' } as any,
    { symbol: "AYGAZ", name: "Aygaz", basePrice: 140, exchange: 'BIST' } as any,
    { symbol: "BAGFS", name: "Bagfaş", basePrice: 30, exchange: 'BIST' } as any,
    { symbol: "BERA", name: "Bera Holding", basePrice: 15, exchange: 'BIST' } as any,
    { symbol: "BIZIM", name: "Bizim Toptan", basePrice: 35, exchange: 'BIST' } as any,
    { symbol: "BIOEN", name: "Biotrend Enerji", basePrice: 18, exchange: 'BIST' } as any,
    { symbol: "BRISA", name: "Brisa", basePrice: 90, exchange: 'BIST' } as any,
    { symbol: "CANTE", name: "Çan2 Termik", basePrice: 18, exchange: 'BIST' } as any,
    { symbol: "CCOLA", name: "Coca-Cola İçecek", basePrice: 500, exchange: 'BIST' } as any,
    { symbol: "CEMTS", name: "Çemtaş", basePrice: 12, exchange: 'BIST' } as any,
    { symbol: "CIMSA", name: "Çimsa", basePrice: 32, exchange: 'BIST' } as any,
    { symbol: "DOAS", name: "Doğuş Otomotiv", basePrice: 260, exchange: 'BIST' } as any,
    { symbol: "ECILC", name: "Eczacıbaşı İlaç", basePrice: 50, exchange: 'BIST' } as any,
    { symbol: "EGEEN", name: "Ege Endüstri", basePrice: 12000, exchange: 'BIST' } as any,
    { symbol: "ENJSA", name: "Enerjisa", basePrice: 55, exchange: 'BIST' } as any,
    ...
    { symbol: "WMT", name: "Walmart", basePrice: 165, exchange: 'NASDAQ' } as any,
    { symbol: "PG", name: "Procter & Gamble", basePrice: 150, exchange: 'NASDAQ' } as any,
    { symbol: "UNH", name: "UnitedHealth", basePrice: 520, exchange: 'NASDAQ' } as any,
    { symbol: "MA", name: "Mastercard", basePrice: 420, exchange: 'NASDAQ' } as any,
    { symbol: "HD", name: "Home Depot", basePrice: 350, exchange: 'NASDAQ' } as any,
    { symbol: "CVX", name: "Chevron", basePrice: 150, exchange: 'NASDAQ' } as any,
    { symbol: "MRK", name: "Merck & Co.", basePrice: 115, exchange: 'NASDAQ' } as any,
    { symbol: "ABBV", name: "AbbVie", basePrice: 160, exchange: 'NASDAQ' } as any,
    { symbol: "KO", name: "Coca-Cola Co.", basePrice: 60, exchange: 'NASDAQ' } as any,
    { symbol: "PEP", name: "PepsiCo", basePrice: 170, exchange: 'NASDAQ' } as any,
    { symbol: "BAC", name: "Bank of America", basePrice: 35, exchange: 'NASDAQ' } as any,
    { symbol: "COST", name: "Costco", basePrice: 680, exchange: 'NASDAQ' } as any,
    { symbol: "MCD", name: "McDonald's", basePrice: 290, exchange: 'NASDAQ' } as any,
    { symbol: "ACN", name: "Accenture", basePrice: 350, exchange: 'NASDAQ' } as any,
    { symbol: "ABT", name: "Abbott Labs", basePrice: 110, exchange: 'NASDAQ' } as any,
    ...
    { symbol: "BCH-USD", name: "Bitcoin Cash", basePrice: 250, exchange: 'CRYPTO' } as any,
    { symbol: "ETC-USD", name: "Ethereum Classic", basePrice: 25, exchange: 'CRYPTO' } as any,
    { symbol: "XMR-USD", name: "Monero", basePrice: 160, exchange: 'CRYPTO' } as any,
    { symbol: "XLM-USD", name: "Stellar", basePrice: 0.11, exchange: 'CRYPTO' } as any,
    { symbol: "ATOM-USD", name: "Cosmos", basePrice: 10, exchange: 'CRYPTO' } as any,
    { symbol: "VET-USD", name: "VeChain", basePrice: 0.03, exchange: 'CRYPTO' } as any,
    { symbol: "FIL-USD", name: "Filecoin", basePrice: 6, exchange: 'CRYPTO' } as any,
    { symbol: "ICP-USD", name: "Internet Computer", basePrice: 12, exchange: 'CRYPTO' } as any,
    { symbol: "HBAR-USD", name: "Hedera", basePrice: 0.08, exchange: 'CRYPTO' } as any,
    { symbol: "NEAR-USD", name: "NEAR Protocol", basePrice: 3.50, exchange: 'CRYPTO' } as any,
    { symbol: "QNT-USD", name: "Quant", basePrice: 110, exchange: 'CRYPTO' } as any,
